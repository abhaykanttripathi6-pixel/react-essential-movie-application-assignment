        ...
        <>
            {
                moviesData.map(movie => {
                    return (
                        ...
                        <div key={movie.id} className=' w-80 my-8 mx-auto border-2 hover:border-amber-300 bg-[rgba(255,255,255,0.02)] rounded-sm hover:shadow-[1px_1px_20px_20px_rgba(255,210,48,0.1)] transition-all duration-600 hover:-translate-y-2 sm:mx-0'>
